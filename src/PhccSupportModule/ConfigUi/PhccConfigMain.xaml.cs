...
using System.Linq;
using PhccSupportModule.ConfigUi.OldForms;
using PhccSupportModule.ConfigUi.OldForms.DigitalConfig;
using PhccSupportModule.ConfigUi.OldForms.Doa7SegConfig;
using PhccSupportModule.HsmSupport.Peripherals;
using Motherboard = PhccSupportModule.HsmSupport.Motherboard;
...
namespace PhccSupportModule.ConfigUi
{
    ...
    public partial class PhccConfigMain : UserControl
    {
        ...
        {
            var currentNodeData = tvConfig.SelectedValue;
          
            if (currentNodeData is BasePeripheral)
            {
                var typedNode = currentNodeData as BasePeripheral;
