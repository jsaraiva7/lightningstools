...
{
    public class AnalogOutput : IPinSignal
    {
        public AnalogOutput()
        {
        ...
        {
            AnalogOutputs.AddRange(GenerateDigitalSignals(pinState, device));
        }
        ...
        private List<AnalogSignal> GenerateDigitalSignals(PinState pinState, object device)
        {
            ...
            {
                Category = "Outputs",
                CollectionName = "Analog Outputs - " + typedDevice.FirmwareVersion,
                FriendlyName = "Analog Outputs at Pin" + pinState.PinNumber,
