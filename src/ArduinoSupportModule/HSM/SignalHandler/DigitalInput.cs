...
{
    public class DigitalInput: IPinSignal
    {
        public DigitalInput()
        {
        ...
        public void InitializeSignals(PinState pinState, object device)
        {
            try
            {
                DigitalInputs.AddRange(GenerateDigitalSignals(pinState, device));
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
        ...
        private List<DigitalSignal> GenerateDigitalSignals(PinState pinState, object device)
        {
            ...
            {
                Category = "Inputs",
                CollectionName = "Digital Inputs - " +  typedDevice.FirmwareVersion,
                FriendlyName = "Digital Input at Pin" + pinState.PinNumber,
