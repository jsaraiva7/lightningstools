    ...
    public class ArduinoSession : IFirmataProtocol, IServoProtocol, II2CProtocol, IStringProtocol, IDisposable
    {
        ...
        public string FirmwareVersion
        {
            get
            {
                ...
                {
                    var firm = this.GetFirmware();
                    return this.ComPort + " - Sketch Name: " + firm.Name + " - Protocol Version: " + firm.MajorVersion + "." + firm.MinorVersion;
                }
                else
                {
                    return "Arduino Device Not Connected";
                }
            }
        }

        /// <summary>
        /// COM PORT for this device
        /// </summary>
        ...
        public BoardCapability GetBoardCapability()
        {
            ...
            var tst = GetMessageFromQueue(new FirmataMessage(MessageType.CapabilityResponse));
